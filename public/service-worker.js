...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_workbox_sw__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_workbox_background_sync__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_workbox_runtime_caching__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_workbox_routing__ = __webpack_require__(171);
var _this = this;
...
var workboxSW = new __WEBPACK_IMPORTED_MODULE_0_workbox_sw__["a" /* default */]();
workboxSW.precache([{
  "url": "css/app.css",
...
var msgQueue = new __WEBPACK_IMPORTED_MODULE_1_workbox_background_sync__["a" /* QueuePlugin */]({
  callbacks: {
    replayDidSucceed: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(hash, res) {
      ...
      function replayDidSucceed(_x, _x2) {
        return _ref.apply(this, arguments);
      }

      return replayDidSucceed;
    }(),
    replayDidFail: function replayDidFail(hash) {
      console.log('replayDidFail');
    },
    requestWillEnqueue: function requestWillEnqueue(reqData) {
      console.log('Enqueue');
    },
    requestWillDequeue: function requestWillDequeue(reqData) {
      console.log(reqData);
    }
  },
  queueName: 'messages'
...
var transQueue = new __WEBPACK_IMPORTED_MODULE_1_workbox_background_sync__["a" /* QueuePlugin */]({
  callbacks: {
    replayDidSucceed: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(hash, res) {
      ...
      function replayDidSucceed(_x3, _x4) {
...
var requestWrapper = new __WEBPACK_IMPORTED_MODULE_2_workbox_runtime_caching__["b" /* RequestWrapper */]({
  plugins: [transQueue, msgQueue]
});

var route = new __WEBPACK_IMPORTED_MODULE_3_workbox_routing__["a" /* RegExpRoute */]({
  regExp: new RegExp('^http://localhost:8000'),
  handler: new __WEBPACK_IMPORTED_MODULE_2_workbox_runtime_caching__["a" /* NetworkOnly */]({ requestWrapper: requestWrapper })
});

var router = new __WEBPACK_IMPORTED_MODULE_3_workbox_routing__["b" /* Router */]();
...
/* harmony default export */ __webpack_exports__["a"] = (WorkboxSW$1);
//# sourceMappingURL=workbox-sw.prod.v2.1.0.mjs.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return QueuePlugin; });
/*
 Copyright 2016 Google Inc. All Rights Reserved.
 Licensed under the Apache License, Version 2.0 (the "License");
 you may not use this file except in compliance with the License.
...
//# sourceMappingURL=workbox-background-sync.prod.v2.0.3.mjs.map
...
"use strict";
/* unused harmony export CacheFirst */
/* unused harmony export CacheOnly */
/* unused harmony export Handler */
/* unused harmony export NetworkFirst */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NetworkOnly; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return RequestWrapper; });
/* unused harmony export StaleWhileRevalidate */
/* unused harmony export getDefaultCacheName */
/*
 Copyright 2016 Google Inc. All Rights Reserved.
 Licensed under the Apache License, Version 2.0 (the "License");
 you may not use this file except in compliance with the License.
...
//# sourceMappingURL=workbox-runtime-caching.prod.v2.0.3.mjs.map
...
"use strict";
/* unused harmony export ExpressRoute */
/* unused harmony export NavigationRoute */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RegExpRoute; });
...
//# sourceMappingURL=workbox-routing.prod.v2.1.0.mjs.map
